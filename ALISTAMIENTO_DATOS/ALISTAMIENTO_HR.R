...
Datos <- file.path('Output_HR_20211007', 'Complementacion')
datos_variable<-file.path('SALIDAS_HR_ALIST')
outPath <- file.path('HUMEDAD_RELATIVA')
...
for (etiqueta in variables) {
  ...
  for (file in list_dir){ 
    ...
    data_out$event_value<-as.double(data_out$event_value)
