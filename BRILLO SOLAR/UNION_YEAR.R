...
ruta_out <- "C:/Users/Lina Maria Abella C/Documents/TRABAJO IDEAM/QC_BRILLO/Brillo_Solar_por_Regiones/SALIDAS_SIN1QER/SALIDAS YEAR/REGION7/"
...
for (file in list_dir){
  ...
  df<-arrange(df, year)
  colnames(df)<- c('Fecha', 'valor','dia_juliano','N','estado','año')
}
